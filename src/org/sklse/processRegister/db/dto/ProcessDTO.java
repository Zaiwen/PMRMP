...
/*Created by Shenlei Yuan, Revised by Zaiwen FENG from 10 Nov 2015*/
...
public class ProcessDTO implements Cloneable{
    ...
    public ProcessDTO(){}
    public ProcessDTO(long id,String uri,String name,
                      String annotation) {
        this.id = id;
        this.uri = uri;
        this.name = name;
    ...
    public ProcessDTO clone(){
        try {
            return (ProcessDTO)super.clone();
