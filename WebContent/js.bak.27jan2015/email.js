...
$("#myemail").remove();
$(this).after("<div id='myemail' style='width:200px; height:auto;text-align:left; background:#fff; color:#6B6B6B; position:absolute; left:495px; top:438px; border:1px solid #ccc;z-index:5px; '></div>");
if($("#myemail").html()){
...
if (press!="" || press!=null){
var emailtxt = "";
var emailvar = new Array("@126.com","@163.com","@qq.com","@sina.com","@gmail.com","@hotmail.com","@foxmail.com","@yahoo.com");
...
emailtxt = emailtxt + "<div class='newemail' style='width:170px; color:#6B6B6B; overflow:hidden;'><font color='#D33022'>" + press + "</font>" + emailvar[i] + "</div>";
													...
													for ( var i = 0; i < emailvar.length; i++) {
														...
														if (theemail
																.indexOf(emailafter) == 0) {
															emailtxt = emailtxt
																	+ "<div class='newemail' style='width:170px; color:#6B6B6B; overflow:hidden;'><font color='#D33022'>"
																	+ emailbefor
																	+ "</font>"
																	+ emailvar[i]
																	+ "</div>";
