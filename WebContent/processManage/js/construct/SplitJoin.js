 ...
 * 
 * @class SplitJoin
 * @constructor SplitJoin
 * @param {String}
 *                id
 */
function SplitJoin(id) {
    this.id = id;
    this.components = [];
}
/**
 * @returns {String} 
 */
SplitJoin.prototype.getId = function() {
    return this.id;
};
/**
 * @private <Array> 该控制结构包含的子结构
 */
SplitJoin.prototype.components = null;
/**
 * @private <mxCell> 该控制结构在画布上的终止节点
 */
SplitJoin.prototype.endVertex = null;
/**
 * @private <mxCell> 该控制结构在画布上的起始节点
 */
SplitJoin.prototype.startVertex = null;
/**
 * 添加控制结构
 * 
 * @param construct
 *                控制结构
 */
SplitJoin.prototype.addComponent = function(component) {
 ...
 *                <number> y坐标
 */
SplitJoin.prototype.draw = function(graph, x, y) {
 ...
 * 所有子控制结构的高度
 */
SplitJoin.prototype.getComponentsHeight = function() {
    var max = 0;
    for ( var i = 0; i < this.components.length; i++) {
 ...
 */
SplitJoin.prototype.getComponentsWidth = function() {
    if (this.components.length == 0) {
	return 0;
    } else {
 ...
 * 
 */
SplitJoin.prototype.getComponents=function (){
    return this.components;
};
/**
 * @return <mxCell> 终止节点
 */
SplitJoin.prototype.getEndVertex = function() {
    return this.endVertex;
};
/**
 * @return <Number> 终止节点的高度
 */
SplitJoin.prototype.getEndVertexHeight = function() {
    return 40;
};
/**
 * @return <Number> 终止节点的宽度
 */
SplitJoin.prototype.getEndVertexWidth = function() {
    return 80;
};
/**
 * @return <Number> 该控制结构的高度
 */
SplitJoin.prototype.getHeight = function() {
    if (this.components.length == 0) {
 ...
 * @return <mxCell> 起始节点
 */
SplitJoin.prototype.getStartVertex = function() {
    return this.startVertex;
};
/**
 * @return <Number> 起始节点的高度
 */
SplitJoin.prototype.getStartVertexHeight = function() {
    return 40;
};
/**
 * @return <Number> 起始节点的宽度
 */
SplitJoin.prototype.getStartVertexWidth = function() {
    return 80;
};
/**
 * @return <Number> 该控制结构的宽度
 */
SplitJoin.prototype.getWidth = function() {
 ...
 * 彻底删除该控制结构
 */
SplitJoin.prototype.remove=function (){
    for(var i=0;i<this.components.length;i++){
 ...
 */
SplitJoin.prototype.removeComponent=function (component){
    var index=-1;
    for(var i=0;i<this.components.length;i++){
 ...
 * @returns {Object}
 */
SplitJoin.prototype.toJson = function() {
    var obj = {};
    obj.ID = this.id;
    obj.components = [];
    for ( var i = 0; i < this.components.length; i++) {
 ...
 * @returns {String}
 */
SplitJoin.prototype.toString=function (){
    return this.id;
};