 ...
 */
Sequence.prototype.components = null;
/**
 * 添加子控制结构
 * 
 * @param component
 ...
 */
Sequence.prototype.addComponent = function(component) {
 ...
 *                <number> y坐标
 */
Sequence.prototype.draw = function(graph, x, y) {
 ...
 * 
 */
Sequence.prototype.getComponents=function (){
    return this.components;
};
/**
 * @return <mxCell> 该控制结构在画布上对应的终止节点
 */
Sequence.prototype.getEndVertex = function() {
    if (this.components.length == 0) {
	return this.vertex;
    } else {
 ...
 */
Sequence.prototype.getStartVertex = function() {
    if (this.components.length == 0) {
	return this.vertex;
    } else {
 ...
 */
Sequence.prototype.removeComponent=function (component){
    var index=-1;
    for(var i=0;i<this.components.length;i++){
