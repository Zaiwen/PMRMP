 ...
 * 
 * @class IfThenElse
 * @constructor IfThenElse
 * @param {String}
 *            id
 */
function IfThenElse(id) {
	this.id = id;
}
/**
 * @type {String}
 */
IfThenElse.prototype.condition = null;
/**
 * @type {Construct}
 */
IfThenElse.prototype.thenConstruct = null;
/**
 * @type {Construct}
 */
IfThenElse.prototype.elseConstruct = null;
/**
 * @private <mxCell> 终止节点
 */
IfThenElse.prototype.endVertex = null;
/**
 * @private <mxCell> 起始节点
 */
IfThenElse.prototype.startVertex = null;
/**
 * 将该控制结构显示在画布上
 * 
 * @param graph
 ...
 *            <number> y坐标
 */
IfThenElse.prototype.draw = function(graph, x, y) {
	...
	// 画出起始节点
			x1 = x + (w - w1) / 2, y1 = y;
	this.startVertex = graph.insertVertex(parent, null, this.id, x1, y1, w1,
			h1, style1);
	this.startVertex.type = "If-Then-Else";
	this.startVertex.itemId = this.id;
	this.startVertex.construct=this;
...
IfThenElse.prototype.getCondition=function (){
	return this.condition;
};
/**
 * @return <ControlContruct>
 */
IfThenElse.prototype.getElseConstruct = function() {
	return this.elseConstruct;
};
/**
 * @return <mxCell> 终止节点
 */
IfThenElse.prototype.getEndVertex = function() {
	return this.endVertex;
};
/**
 * @return <Number> 终止节点的高度
 */
IfThenElse.prototype.getEndVertexHeight = function() {
	return 40;
};
/**
 * @return <Number> 终止节点的宽度
 */
IfThenElse.prototype.getEndVertexWidth = function() {
	return 40;
};
/**
 * @return <Number> 高度
 */
IfThenElse.prototype.getHeight = function() {
	if (this.thenConstruct == null) {
 ...
 * @return <mxCell> 起始节点
 */
IfThenElse.prototype.getStartVertex = function() {
	return this.startVertex;
};
/**
 * @return <Number> 起始节点的高度
 */
IfThenElse.prototype.getStartVertexHeight = function() {
	return 60;
};
/**
 * @return <Number> 起始节点的宽度
 */
IfThenElse.prototype.getStartVertexWidth = function() {
	var _div = $("<div></div>");
	_div.text(this.id);
	_div.appendTo($('body'));
	_div.css( {
 ...
 * @return <ControlContruct>
 */
IfThenElse.prototype.getThenConstruct = function() {
	return this.thenConstruct;
};
/**
 * @return <Number> 宽度
 */
IfThenElse.prototype.getWidth = function() {
...
IfThenElse.prototype.getId = function() {
	return this.id;
};
/**
 * @param {String}
 *            condition
 */
IfThenElse.prototype.setCondition = function(condition) {
	this.condition = condition;
}

IfThenElse.prototype.setThenConstruct = function(construct) {
	this.thenConstruct = construct;
}

IfThenElse.prototype.setElseConstruct = function(construct) {
	this.elseConstruct = construct;
};

IfThenElse.prototype.removeThenConstruct = function (construct)
{
}

IfThenElse.prototype.toString=function (){
	return this.id;
};