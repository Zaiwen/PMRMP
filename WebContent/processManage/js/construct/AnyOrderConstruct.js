 ...
 * Any-Order 控制结构
 * 
 * @class AnyOrderConstruct
 * @construct AnyOrderConstruct
 * @param {String} id
 */
function AnyOrderConstruct(id) {
    this.id=id;
    this.components = [];
}
/**
 ...
 */
AnyOrderConstruct.prototype.components = null;
/**
 * @private <mxCell> 该控制结构在画布上的终止节点
 */
AnyOrderConstruct.prototype.endVertex = null;
/**
 * @private <mxCell> 该控制结构在画布上的起始节点
 */
AnyOrderConstruct.prototype.startVertex = null;
/**
 * 添加控制结构
 * 
 * @param construct
 *                控制结构
 */
AnyOrderConstruct.prototype.addComponent = function(component) {
 ...
 *                <number> y坐标
 */
AnyOrderConstruct.prototype.draw = function(graph, x, y) {
    ...
    this.startVertex = graph.insertVertex(parent, null, 'Any-Order', x1, y1,
	    w1, h1, style);
    // 画出终止节点
    x2 = x1;
    ...
    this.endVertex = graph.insertVertex(parent, null, '/Any-Order', x2, y2, w2,
	    h2, style);
    // 画出子控制结构
 ...
 * 
 */
AnyOrderConstruct.prototype.getComponents=function (){
    return this.components;
};
/**
 * 所有子控制结构的高度
 */
AnyOrderConstruct.prototype.getComponentsHeight = function() {
    var max = 0;
    for ( var i = 0; i < this.components.length; i++) {
 ...
 */
AnyOrderConstruct.prototype.getComponentsWidth = function() {
    if (this.components.length == 0) {
	return 0;
    } else {
 ...
 * @return <mxCell> 终止节点
 */
AnyOrderConstruct.prototype.getEndVertex = function() {
    return this.endVertex;
};
/**
 * @return <Number> 终止节点的高度
 */
AnyOrderConstruct.prototype.getEndVertexHeight = function() {
    return 40;
};
/**
 * @return <Number> 终止节点的宽度
 */
AnyOrderConstruct.prototype.getEndVertexWidth = function() {
    return 80;
};
/**
 * @return <Number> 该控制结构的高度
 */
AnyOrderConstruct.prototype.getHeight = function() {
    if (this.components.length == 0) {
 ...
 * @returns {String}
 */
AnyOrderConstruct.prototype.getId = function() {
    return this.id;
};
/**
 * @return <mxCell> 起始节点
 */
AnyOrderConstruct.prototype.getStartVertex = function() {
    return this.startVertex;
};
/**
 * @return <Number> 起始节点的高度
 */
AnyOrderConstruct.prototype.getStartVertexHeight = function() {
    return 40;
};
/**
 * @return <Number> 起始节点的宽度
 */
AnyOrderConstruct.prototype.getStartVertexWidth = function() {
    return 80;
};
/**
 * @return <Number> 该控制结构的宽度
 */
AnyOrderConstruct.prototype.getWidth = function() {
 ...
 * 彻底删除该控制结构
 */
AnyOrderConstruct.prototype.remove=function (){
    for(var i=0;i<this.components.length;i++){
 ...
 */
AnyOrderConstruct.prototype.removeComponent=function (component){
    var index=-1;
    for(var i=0;i<this.components.length;i++){
 ...
 * @returns {Object}
 */
AnyOrderConstruct.prototype.toJson=function (){
    var obj={};
    obj.ID=this.id;
    obj.components=[];
    for(var i=0;i<this.components.length;i++){
 ...
 * @returns {Element}
 */
AnyOrderConstruct.prototype.toXml=function (){
    var $seq=$("<anyorder/>");
    $seq.attr("id",this.id);
    for(var i=0;i<this.components.length;i++){
 ...
 * @returns {String}
 */
AnyOrderConstruct.prototype.toString=function (){
    return this.id;
};