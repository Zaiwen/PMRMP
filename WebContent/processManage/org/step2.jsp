...
<body>
	<div id="manage">
		<div class="head">
			...
			<div class="title">插件应用 - 选择插件（2/3）</div>
		</div>
		<div class="body">
			...
			<div id="list">
				<table>
					...
					<%
						...
						ac.connDB("bpep");
						String sql=" select pluginprocess.id,pluginprocess.name,isvuser.name,pluginprocess.time from pluginprocess,isvuser where pluginprocess.author=isvuser.id;";
						...
						while(rs.next()){
							...
							String time = rs.getDate(4).toString();
							out.print("<tr class='item'>");
							out.print("<td class='name'><a href='../epc/index.jsp?process="+process+"&extension=" + id+"'>" + name + "</a>");
